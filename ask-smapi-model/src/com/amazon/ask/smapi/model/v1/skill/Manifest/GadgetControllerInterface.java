...
public final class GadgetControllerInterface extends com.amazon.ask.smapi.model.v1.skill.Manifest.ModelInterface  {
    ...
    private GadgetControllerInterface(Builder builder) {
        String discriminatorValue = "GADGET_CONTROLLER";
    ...
    public String toString() {
        ...
        sb.append("class GadgetControllerInterface {\n");
    ...
    public static class Builder {
        ...
        public GadgetControllerInterface build() {
            return new GadgetControllerInterface(this);
        }
    }
}
