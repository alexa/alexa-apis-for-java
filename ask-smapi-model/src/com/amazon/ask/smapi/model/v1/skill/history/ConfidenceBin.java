...
public enum ConfidenceBin {
  ...
  @JsonCreator
  public static ConfidenceBin fromValue(String text) {
    for (ConfidenceBin b : ConfidenceBin.values()) {
      if (String.valueOf(b.value).equals(text)) {
        return b;
      }
    }
    return ConfidenceBin.UNKNOWN_TO_SDK_VERSION;
  }
}
