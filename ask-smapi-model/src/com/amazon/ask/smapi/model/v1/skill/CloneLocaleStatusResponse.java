...
public final class CloneLocaleStatusResponse {
    ...
    private Map<String, com.amazon.ask.smapi.model.CloneLocaleResourceStatus> targetLocales = new HashMap<String, com.amazon.ask.smapi.model.CloneLocaleResourceStatus>();
    ...
    **/
    @JsonProperty("targetLocales")
    public Map<String, com.amazon.ask.smapi.model.CloneLocaleResourceStatus> getTargetLocales() {
        return targetLocales;
    }
    ...
    public static class Builder {
        ...
        private Map<String, com.amazon.ask.smapi.model.CloneLocaleResourceStatus> targetLocales;
        ...
        public Builder withTargetLocales(Map<String, com.amazon.ask.smapi.model.CloneLocaleResourceStatus> targetLocales) {
            this.targetLocales = targetLocales;
            return this;
        }

        public Builder putTargetLocalesItem(String key, com.amazon.ask.smapi.model.CloneLocaleResourceStatus targetLocalesItem) {
            if (this.targetLocales == null) {
                this.targetLocales = new HashMap<String, com.amazon.ask.smapi.model.CloneLocaleResourceStatus>();
            }
