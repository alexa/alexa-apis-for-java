...
public final class Intent {
    ...
    @JsonProperty("slots")
    private Map<String, com.amazon.ask.smapi.model.v1.skill.nlu.evaluations.SlotsProps> slots = new HashMap<String, com.amazon.ask.smapi.model.v1.skill.nlu.evaluations.SlotsProps>();
    ...
    **/
    @JsonProperty("slots")
    public Map<String, com.amazon.ask.smapi.model.v1.skill.nlu.evaluations.SlotsProps> getSlots() {
        return slots;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Intent v1SkillNluEvaluationsIntent = (Intent) o;
        return Objects.equals(this.name, v1SkillNluEvaluationsIntent.name) &&
            Objects.equals(this.confirmationStatus, v1SkillNluEvaluationsIntent.confirmationStatus) &&
            Objects.equals(this.slots, v1SkillNluEvaluationsIntent.slots);
    }
    ...
    public static class Builder {
        ...
        private Map<String, com.amazon.ask.smapi.model.v1.skill.nlu.evaluations.SlotsProps> slots;
        ...
        public Builder withSlots(Map<String, com.amazon.ask.smapi.model.v1.skill.nlu.evaluations.SlotsProps> slots) {
            this.slots = slots;
            return this;
        }

        public Builder putSlotsItem(String key, com.amazon.ask.smapi.model.v1.skill.nlu.evaluations.SlotsProps slotsItem) {
            if (this.slots == null) {
                this.slots = new HashMap<String, com.amazon.ask.smapi.model.v1.skill.nlu.evaluations.SlotsProps>();
            }
