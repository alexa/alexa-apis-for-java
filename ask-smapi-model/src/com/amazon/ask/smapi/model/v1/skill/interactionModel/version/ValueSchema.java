...
@JsonDeserialize(builder = ValueSchema.Builder.class)
public final class ValueSchema {
    ...
    private ValueSchema(Builder builder) {
        if (builder.id != null) {
            this.id = builder.id;
        }
    ...
    **/
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ValueSchema v1SkillInteractionModelVersionValueSchema = (ValueSchema) o;
        return Objects.equals(this.id, v1SkillInteractionModelVersionValueSchema.id) &&
            Objects.equals(this.name, v1SkillInteractionModelVersionValueSchema.name);
    }
    ...
    public static class Builder {
        private String id;
        private com.amazon.ask.smapi.model.v1.skill.interactionModel.version.ValueSchemaName name;
