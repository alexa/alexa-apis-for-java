...
/**
 * GetASRAnnotationSetsPropertiesResponse
 */

@JsonDeserialize(builder = GetASRAnnotationSetsPropertiesResponse.Builder.class)
public final class GetASRAnnotationSetsPropertiesResponse {
    ...
    private GetASRAnnotationSetsPropertiesResponse(Builder builder) {
    ...
    **/
    ...
    public String toString() {
        ...
        sb.append("class GetASRAnnotationSetsPropertiesResponse {\n");
    ...
    public static class Builder {
        ...
        public GetASRAnnotationSetsPropertiesResponse build() {
            return new GetASRAnnotationSetsPropertiesResponse(this);
        }
    }
}
