...
@JsonDeserialize(builder = CatalogStatus.Builder.class)
public final class CatalogStatus {
    ...
    private CatalogStatus(Builder builder) {
    ...
    **/
    @JsonProperty("lastUpdateRequest")
    public com.amazon.ask.smapi.model.v1.skill.interactionModel.catalog.LastUpdateRequest getLastUpdateRequest() {
        return lastUpdateRequest;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CatalogStatus v1SkillInteractionModelCatalogCatalogStatus = (CatalogStatus) o;
        return Objects.equals(this.lastUpdateRequest, v1SkillInteractionModelCatalogCatalogStatus.lastUpdateRequest);
    }
    ...
    public static class Builder {
        private com.amazon.ask.smapi.model.v1.skill.interactionModel.catalog.LastUpdateRequest lastUpdateRequest;
        ...
        public CatalogStatus build() {
            return new CatalogStatus(this);
        }
    }
}
