...
public final class ReferencedResourceJobsComplete extends com.amazon.ask.smapi.model.v1.skill.interactionModel.jobs.Trigger  {
    ...
    private ReferencedResourceJobsComplete(Builder builder) {
        String discriminatorValue = "ReferencedResourceJobsComplete";
    ...
    public String toString() {
        ...
        sb.append("class ReferencedResourceJobsComplete {\n");
    ...
    public static class Builder {
        ...
        public ReferencedResourceJobsComplete build() {
            return new ReferencedResourceJobsComplete(this);
        }
    }
}
