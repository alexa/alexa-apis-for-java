...
@JsonDeserialize(builder = HostedSkillProvisioningLastUpdateRequest.Builder.class)
public final class HostedSkillProvisioningLastUpdateRequest {
    ...
    private HostedSkillProvisioningLastUpdateRequest(Builder builder) {
    ...
    **/
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HostedSkillProvisioningLastUpdateRequest v1SkillHostedSkillProvisioningLastUpdateRequest = (HostedSkillProvisioningLastUpdateRequest) o;
        return Objects.equals(this.status, v1SkillHostedSkillProvisioningLastUpdateRequest.status) &&
            Objects.equals(this.errors, v1SkillHostedSkillProvisioningLastUpdateRequest.errors) &&
            Objects.equals(this.warnings, v1SkillHostedSkillProvisioningLastUpdateRequest.warnings);
    }

    @Override
    public int hashCode() {
        return Objects.hash(status, errors, warnings);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class HostedSkillProvisioningLastUpdateRequest {\n");
    ...
    public static class Builder {
        ...
        public HostedSkillProvisioningLastUpdateRequest build() {
            return new HostedSkillProvisioningLastUpdateRequest(this);
        }
    }
}
