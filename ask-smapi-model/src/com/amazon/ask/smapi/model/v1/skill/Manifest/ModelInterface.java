...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = com.amazon.ask.smapi.model.v1.skill.Manifest.VideoAppInterface.class, name = "VIDEO"),
  @JsonSubTypes.Type(value = com.amazon.ask.smapi.model.v1.skill.Manifest.CustomInterface.class, name = "CUSTOM_INTERFACE"),
  @JsonSubTypes.Type(value = com.amazon.ask.smapi.model.v1.skill.Manifest.AudioInterface.class, name = "AUDIO"),
