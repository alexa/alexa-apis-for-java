...
public final class EvaluateResponse {
    ...
    private EvaluateResponse(Builder builder) {
        if (builder.id != null) {
            this.id = builder.id;
        }
    }
    ...
    **/
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EvaluateResponse v1SkillNluEvaluationsEvaluateResponse = (EvaluateResponse) o;
        return Objects.equals(this.id, v1SkillNluEvaluationsEvaluateResponse.id);
    }
