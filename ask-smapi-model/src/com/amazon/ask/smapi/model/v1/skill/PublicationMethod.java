...
public enum PublicationMethod {
  ...
  PublicationMethod(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PublicationMethod fromValue(String text) {
    for (PublicationMethod b : PublicationMethod.values()) {
      if (String.valueOf(b.value).equals(text)) {
        return b;
      }
    }
    return PublicationMethod.UNKNOWN_TO_SDK_VERSION;
  }
}
