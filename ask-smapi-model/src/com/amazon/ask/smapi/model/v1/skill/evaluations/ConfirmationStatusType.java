...
public enum ConfirmationStatusType {
  ...
  ConfirmationStatusType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ConfirmationStatusType fromValue(String text) {
    for (ConfirmationStatusType b : ConfirmationStatusType.values()) {
      if (String.valueOf(b.value).equals(text)) {
        return b;
      }
    }
    return ConfirmationStatusType.UNKNOWN_TO_SDK_VERSION;
  }
}
