...
public final class SlotResolutions {
    ...
    private List<com.amazon.ask.smapi.model.v2.skill.simulations.ResolutionsPerAuthorityItems> resolutionsPerAuthority = new ArrayList<com.amazon.ask.smapi.model.v2.skill.simulations.ResolutionsPerAuthorityItems>();
    ...
    **/
    @JsonProperty("resolutionsPerAuthority")
    public List<com.amazon.ask.smapi.model.v2.skill.simulations.ResolutionsPerAuthorityItems> getResolutionsPerAuthority() {
        return resolutionsPerAuthority;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SlotResolutions v2SkillSimulationsSlotResolutions = (SlotResolutions) o;
        return Objects.equals(this.resolutionsPerAuthority, v2SkillSimulationsSlotResolutions.resolutionsPerAuthority);
    }
    ...
    public static class Builder {
        private List<com.amazon.ask.smapi.model.v2.skill.simulations.ResolutionsPerAuthorityItems> resolutionsPerAuthority;

        private Builder() {}

        @JsonProperty("resolutionsPerAuthority")

        public Builder withResolutionsPerAuthority(List<com.amazon.ask.smapi.model.v2.skill.simulations.ResolutionsPerAuthorityItems> resolutionsPerAuthority) {
            this.resolutionsPerAuthority = resolutionsPerAuthority;
            return this;
        }

        public Builder addResolutionsPerAuthorityItem(com.amazon.ask.smapi.model.v2.skill.simulations.ResolutionsPerAuthorityItems resolutionsPerAuthorityItem) {
            if (this.resolutionsPerAuthority == null) {
                this.resolutionsPerAuthority = new ArrayList<com.amazon.ask.smapi.model.v2.skill.simulations.ResolutionsPerAuthorityItems>();
            }
