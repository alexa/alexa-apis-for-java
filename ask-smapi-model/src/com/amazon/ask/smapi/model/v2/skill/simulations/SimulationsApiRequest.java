...
public final class SimulationsApiRequest {
    ...
    @JsonProperty("input")
    private com.amazon.ask.smapi.model.v2.skill.simulations.Input input = null;

    @JsonProperty("device")
    private com.amazon.ask.smapi.model.v2.skill.simulations.Device device = null;
    ...
    **/
    @JsonProperty("input")
    public com.amazon.ask.smapi.model.v2.skill.simulations.Input getInput() {
        return input;
    }
    ...
    **/
    @JsonProperty("device")
    public com.amazon.ask.smapi.model.v2.skill.simulations.Device getDevice() {
        return device;
    }
    ...
    **/
    @JsonProperty("session")
    public com.amazon.ask.smapi.model.v2.skill.simulations.Session getSession() {
        return session;
    }
    ...
    **/
    ...
    public static class Builder {
        ...
        public Builder withInput(com.amazon.ask.smapi.model.v2.skill.simulations.Input input) {
            this.input = input;
            return this;
        }
        ...
        public Builder withDevice(com.amazon.ask.smapi.model.v2.skill.simulations.Device device) {
            this.device = device;
            return this;
        }
