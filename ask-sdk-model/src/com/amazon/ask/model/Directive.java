...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = com.amazon.ask.model.interfaces.conversations.ResetContextDirective.class, name = "Conversations.ResetContext"),
  @JsonSubTypes.Type(value = com.amazon.ask.model.dialog.DelegateRequestDirective.class, name = "Dialog.DelegateRequest"),
  ...
  @JsonSubTypes.Type(value = com.amazon.ask.model.interfaces.alexa.presentation.aplt.RenderDocumentDirective.class, name = "Alexa.Presentation.APLT.RenderDocument"),
  ...
  @JsonSubTypes.Type(value = com.amazon.ask.model.interfaces.alexa.presentation.aplt.ExecuteCommandsDirective.class, name = "Alexa.Presentation.APLT.ExecuteCommands"),
  ...
  @JsonSubTypes.Type(value = com.amazon.ask.model.interfaces.alexa.presentation.apl.SendTokenListDataDirective.class, name = "Alexa.Presentation.APL.SendTokenListData"),
