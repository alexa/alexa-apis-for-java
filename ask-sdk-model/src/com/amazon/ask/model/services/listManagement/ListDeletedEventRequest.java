...
@JsonDeserialize(builder = ListDeletedEventRequest.Builder.class)
public final class ListDeletedEventRequest extends com.amazon.ask.model.Request  {
    ...
    private ListDeletedEventRequest(Builder builder) {
        String discriminatorValue = "AlexaHouseholdListEvent.ListDeleted";
    ...
    **/
    ...
    public static class Builder {
        ...
        public ListDeletedEventRequest build() {
            return new ListDeletedEventRequest(this);
        }
    }
}
